...
import com.example.sbs.smishingdetector.model.DetectionApkResponse
import com.example.sbs.smishingdetector.model.DetectionHistory
import com.example.sbs.smishingdetector.model.ReportHistory
...
interface ApiService {
    ...
    @POST("/apk/predict")
    suspend fun uploadApkFeatureBatch(
        @Body payloads: List<FeaturePayload>
    ): Response<DetectionApkResponse>
}